...
useHead({
    titleTemplate: 'Notifications - Settings | app.leandrocesar.com',
});
                ...
                <div>
                    <div class='bor'>
                            ...
                            <div>
                                ...
                                <p>Receba notificações na área de trabalho.</p>
                            </div>
                                <label class="switch">
                                    <input type="checkbox">
                                    <span class="slider"></span>
          ...
          <div class="line-columns">
                ...
                <div>
                    <div class='bor'>
                            ...
                            <div>
                                <h3>Atualizações de produtos/serviços</h3>
                                <p>Receba um e-mail mensal com todos os novos recursos e atualizações.</p>
                            </div>
                                <label class="switch">
                                    <input type="checkbox">
                                    <span class="slider"></span>
                            ...
                            <div>
                                ...
                                <p>Receba e-mails sobre atualizações importantes, como correções de segurança, manutenção, etc.</p>
                            </div>
                                <label class="switch">
                                    <input type="checkbox">
                                    <span class="slider"></span>
...
.line-columns {
    display: grid;
        grid-template-columns: .4fr 1fr; /* Barra fixa e conteúdo */
