...
<template>
    ...
    <div class="layout-no-sidebar">
      ...
      <input class='name' type="text" id="flexaoBraco" style='width: 500px; margin-left: .5rem;' v-model='user.name' autofocus
...
<div>
  ...
  <div class="floating-div">
    ...
    <!-- Informações do usuário -->
    <div class="head-name">
      <input type="text" id="flexaoBraco"  class='user-name' style='width: 220px;' v-model='user.username' autofocus
...
<div>
      ...
      class='xp-user' autocomplete="flexaoBraco" placeholder='Xp do usuário?'>
        ...
        <div>
          ...
          <div class='bor'>
                            <div class="theme-switch">
                                ...
                                class='birthday' autocomplete="flexaoBraco">
                   </div>
              <div>
                                    <h4>Idade</h4>
                                    <h3>39 anos</h3>
                                ...
                                autocomplete="flexaoBraco" class='form-create'>
                                </div>
                            </div>
            ...
            <div class="theme-switch">
                                ...
                                autocomplete="flexaoBraco" class='day'>
                                </div>
                                <div>
                                    <h4>Tempos de treino</h4>
                                <input class='terms' type="text" id="flexaoBraco" style='width: 150px;' v-model='user.time' autofocus
                                autocomplete="flexaoBraco">
                                </div>
                                <div>
                                    <h4>Dia de Pagamento</h4>
                                <input class='pay-day' type="text" id="flexaoBraco" style='width: 150px;' v-model='user.payDay' autofocus
                                autocomplete="flexaoBraco">
                                </div>
             </div>
          </div>
...
.nav-users a.router-link-exact-active {
  ...
  .dark-mode .nav-users a.router-link-exact-active {
  color: var(--player-color);
  }
.users-list {
    display: flex;
...
.name, .user-name, .xp-user, .birthday, .form-create, .cadastro, .email, .day, .terms, .pay-day {
