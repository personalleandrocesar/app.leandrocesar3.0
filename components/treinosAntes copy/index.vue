...
const Users = await useFetch(`https://api.leandrocesar.com/users/${route.params.id}/treinos`);
const UsersTrainnig = await useFetch(`https://api.leandrocesar.com/users/${route.params.id}/treino`);
