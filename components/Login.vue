...
<div v-if='divLogin'>
  ...
  <div>
    <div class="head-logo" id="sobre">
        <div class="logo">
          <NuxtLink class="logo-link">
              <svg class="logo-circle-pt"  version="1.0" xmlns="http://www.w3.org/2000/svg"
            ...
            <div class="logo-text" :class="{ active: menuOpen }">
              <h1>Leandro Cesar</h1>
              <span>PERSONAL TRAINER &amp; KRAV-MAGA</span>
            </div>
          </NuxtLink>
        </div>
    </div>
...
input:active {
  border-color: var(--player-color)80;
}
...
@media(max-width: 600px){
    .site-header{padding: 1.5rem 1rem; backdrop-filter: blur(5px); }
    .logo-circle{width:50px;height:50px;}
    .logo-circle-pt{margin: -5px -20px 0 0;}
    .logo-text h1{font-size:1.2rem;}
    .logo-text span{font-size:0.6rem;}
    .menu-open{padding-top:10.5rem;}
    .menu-open .links a{font-size:2rem;}
    .bar{padding: 2.5rem 1.5rem 2.5rem 2.5rem;}
    .site-footer{
      font-size: .8rem;
    }
}
