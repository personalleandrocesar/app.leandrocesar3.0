<template>
 <div class="location">
    ...
    <div v-if="location">
      ...
      <p><strong>Long.:</strong> {{ location.lng }}</p>

    </div>

    <div v-if="localAtual">
      <p><strong>Nome do local:</strong> {{ localAtual }}</p>
    </div>

    <div v-if="address">
      <p><strong>Endereço:<br></strong> {{ address }}</p>
    </div>

     <div v-if="address">
      <span  v-if="address">*Para desativar a GeoLocalização, faça pelo navegador!</span>
    </div>
